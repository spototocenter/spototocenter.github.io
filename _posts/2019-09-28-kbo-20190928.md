...
<h3>KBL</h3>
<h4><span style="color:red"> ![KGC.logo](../assets/icons/logo_kgc.png){: height="70"} 안양KGC(홈) VS ![DB.logo](../assets/icons/logo_db.png){: height="70"}원주DB(원정) </span></h4>
<p>This is some text. <img height="70" src="../assets/icons/logo_kgc.png" alt="Smiley face" align="middle"> This is some text.</p>
