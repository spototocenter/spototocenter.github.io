...
.tg .tg-ahyy{font-size:200%;background-color:#ffffff;border-color:#ffffff;text-align:center;vertical-align:top}
.tg .tg-xf23{font-size:150%;background-color:#ffffff;border-color:#ffffff;text-align:center;vertical-align:top}
.tg .tg-wo9u{font-size:200%;background-color:#ffffff;color:#fe0000;border-color:#ffffff;text-align:center;vertical-align:top}
.tg .tg-yja9{font-size:200%;background-color:#ffffff;color:#3531ff;border-color:#ffffff;text-align:center;vertical-align:top}
</style>
<table class="tg">
  <tr>
    <th class="tg-ahyy" rowspan="2"><img src="../images/jekyll-logo.png" alt="My Image" height="50"></th>
    <th class="tg-wk8r">안양KGC(홈)</th>
    <th class="tg-xf23" rowspan="2"><br>vs</th>
    <th class="tg-wk8r">(원정)서울삼성</th>
    <th class="tg-ahyy" rowspan="2"><img src="../images/jekyll-logo.png" alt="My Image" height="100"></th>
  </tr>
  <tr>
